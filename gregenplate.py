...
class GenPlate:
    ...
    def __init__(self,fontCh,fontEng,NoPlates):
        ...
        self.img=np.array(Image.new("RGB", (226+29,70),(255,255,255)))
      #  self.bg  = cv2.resize(cv2.imread("./images/template2.bmp"),(226,70));
        self.bg = cv2.resize(cv2.imread("./images/template2.bmp"), (226+29, 70));
...
#G.genBatch(100,2,range(31,65),"./platev",(272,72))
G.genBatch(2000,2,range(31,65),"./gplatev",(96,32))
